...
For this project, we expect you to look at these concepts:
  ...
  * [Python packages](https://github.com/sintayehuCSE/Concepts/blob/master/concepts66.md)
  * [AirBnB clone](https://github.com/sintayehuCSE/Concepts/blob/master/concepts74.md)
  
![Airbnb](images/Airbnb_White_bg.png)
...
## Python Unit Tests
  ...
  * e.g., For `models/base_model.py`, unit tests must be in: t`ests/test_models/test_base_model.py`
...
![Storage Engine](images/Storage-Engine_0.png)
